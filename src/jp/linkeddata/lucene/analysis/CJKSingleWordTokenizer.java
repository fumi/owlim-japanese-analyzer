 ...
 *
 */
public final class CJKSingleWordTokenizer extends Tokenizer {
     ...
     * @param in I/O reader
     */
    public CJKSingleWordTokenizer(Reader in) {
      super(in);
    }

    public CJKSingleWordTokenizer(AttributeSource source, Reader in) {
      super(source, in);
    }

    public CJKSingleWordTokenizer(AttributeFactory factory, Reader in) {
      super(factory, in);
    }
